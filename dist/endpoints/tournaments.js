...
class Tournaments {
    ...
    games(id, options = {}, ndjson = false) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof id !== 'string')
                throw new TypeError('Tournament ID must be a string');
            let def = {
                moves: true,
                tags: true,
                clocks: false,
     ...
     */
    results(id, { nb = 9, fetchUsers = true, filter = () => true } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof id !== 'string')
                throw new TypeError('Tournament ID must be a string');
            if (typeof nb !== 'number')
                throw new TypeError('Number of games to fetch must be type Number');
            if (typeof fetchUsers !== 'boolean')
                throw new TypeError('fetch takes Boolean values');
            if (nb <= 0)
                throw new RangeError('Number of results to fetch is outside the range');
     ...
     */
    lastShield(variant, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const ids = yield this.shields(variant, false);
                let id = ids.shift();
                return yield this.results(id, data);
            }
            catch (e) {
                if (e)
                    throw e;
    ...
    create(tournamentOptions = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if ((!this.oauth || !this.result) && !this.access_token)
                    throw new Error('Insufficient permissions! Must connect OAuth app first.');
    ...
    shields(variant = '') {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (variant)
                    return yield this.constructor.getV2Variant(variant);
                else
                    return yield this.constructor.getV2Shields();
            }
            catch (e) {
                if (e)
                    throw e;
     ...
     * @returns {string[]}
     */
    static getV2Variant(variant) {
        return __awaiter(this, void 0, void 0, function* () {
            if (config.variants.concat(config.shield).indexOf(variant) === -1)
                throw new Error('Variant ' + variant + ' does not have a valid value:\n' + config.variants.concat(config.shield).join(', '));
            const data = yield rp.get(`${config.uri}tournament/shields/${variant}`);
            let found = [];
    ...
    static getV1Shields() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield rp.get(`${config.uri}tournament/shields`);
            let output = {};
            const $ = cheerio.load(data);
